...
public class recommendedSongsItem {
    ...
    public recommendedSongsItem(String songname, int SID, int AID, int UID, String album, String genre, String language, String artistname, String songurl) {
